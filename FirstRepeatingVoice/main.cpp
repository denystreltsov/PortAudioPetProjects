...
int main(int argc, char** argv)
{
    ...
    for(int i = 0 ; i < number_devices; ++i)
    {
        ...
        printf("write down [%d] to choose for Output Device: [%s]: \n",
               i,Pa_GetDeviceInfo(i)->name);
        else if(Pa_GetDeviceInfo(i)->maxOutputChannels == 0)
        {
            printf("write down [%d] to choose for Input Device: [%s]: \n",
                   i,Pa_GetDeviceInfo(i)->name);
        }
        else
        {
            printf("write down [%d] to choose for Input and Output Device: [%s]: \n",
                   i,Pa_GetDeviceInfo(i)->name);
        }
